...
const RegisterForm = () => {
  ...
  return (
    <div className='register-form'>
      <h2><FormattedMessage id='register_form:register_title' /></h2>
      ...
      <h2><FormattedMessage id='register_form:form_data_title' /></h2>
      ...
      <h2><FormattedMessage id='register_form:live_data_title' /></h2>
